  ...
  <ion-page>
    <ion-content>
      <div class="students-container">
        ...
        <!-- Students Grid -->
        <ion-grid class="students-grid">
          <ion-row>
            <ion-col size="6" v-for="(student, index) in students" :key="index">
              <div 
                class="student-card"
...
const selectStudent = (index: number) => {
  students.value = students.value.map((student, i) => ({
    ...student,
    selected: i === index
  }));
};
