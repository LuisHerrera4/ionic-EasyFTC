        ...
        <div class="register-container">
          ...
          <div class="social-login">
            ...
            <div class="social-buttons">
              <router-link to="/login/profesor/facebook" class="social-btn">
                <img src="/facebook.png" alt="logo facebook" class="social-icon" />
              </router-link>
              <router-link to="/login/profesor/google" class="social-btn">
                <img src="/google.svg" alt="logo google" class="social-icon" />
              </router-link>
              <router-link to="/login/profesor/apple" class="social-btn">
          ...
          <p class="login-text">
            ...
            <router-link to="/login/profesor/login" class="login-link">
              Inicia Sesión
            </router-link>
          </p>
        </div>
